...
Passionate about transforming raw data into actionable insights, designing interactive cloud-based BI dashboards, and optimizing data workflows. Experiencing in data manipulation, cloud data warehousing, and digital/product analytics.

---

## 🛠️ Tech Stack & Tools
* **Data Analysis & Querying:** SQL (Google BigQuery, PostgreSQL)
* **Business Intelligence (BI):** Tableau, Power BI, Looker Studio
* **Product & Web Analytics:** Amplitude, Google Analytics 4 (GA4)
* **Data Science & Automation:** Python (Pandas, NumPy), Google Sheets

---

## 🚀 Live Project Portfolio (All-in-One)

### 📊 1. Cloud-Based Data Warehousing & Advanced SQL Analytics
...
* **Description:** Yönetici özeti, finansal KPI takibi ve operasyonel süreçlerin takibi için çok boyutlu, dinamik ve interaktif dashboard tasarımları.
* **🔗 Active Dashboards:**
  * [Tableau Public Profile & Vizzes Portfolio](https://public.tableau.com/app/profile/suat.amet/vizzes)
  * [Looker Studio Dynamic Dashboard](https://datastudio.google.com/s/pLO8WhKL5sQ)
  * [Power BI Live Executive Report](https://app.powerbi.com/view?r=eyJrIjoiZTNhZWI0MDctZjAxZi00NDk2LThiOTQtZTA2ZTQyZGFkNzc4IiwidCI6IjgxYWMzZmNiLTBlMzQtNDJmNS1iZThlLTdiOGQyMjg2MGUxYiIsImMiOjl9)

### 🎯 3. Product & Digital User Analytics
...
* **Email:** [E-posta Adresini Buraya Yaz]
